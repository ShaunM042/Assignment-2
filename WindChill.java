...
public class WindChill {
	...
	double T=0.0,V=0.0;
    T=Math.abs(Double.parseDouble(args [0]));
    V=Math.abs(Double.parseDouble(args [1]));
    validateInput=(T >50) || (V >120) || (V<3);
    double w = validateInput? 0: 35.74 + 0.6215 * T + (0.4275 * T - 35.75)*Math.pow(V, 0.16);
